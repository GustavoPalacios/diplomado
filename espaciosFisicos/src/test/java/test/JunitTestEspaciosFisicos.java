...
public class JunitTestEspaciosFisicos {
	...
	public void test() throws MalformedURLException,
	 ...
	 String outputString = "";
	 String wsURL = "http://localhost:8080/espaciosFisicos/services/DelegadoEspaciosfisicos?wsdl";
	 URL url = new URL(wsURL);
	 URLConnection connection = url.openConnection();
	 HttpURLConnection httpConn = (HttpURLConnection)connection;
	 ByteArrayOutputStream bout = new ByteArrayOutputStream();
	 String xmlInput =     "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:del=\"http://delegado.espaciosFisicos\">"+
                           "<soapenv:Header/><soapenv:Body><del:getGruposAll/></soapenv:Body></soapenv:Envelope>";
	 byte[] buffer = new byte[xmlInput.length()];
	 buffer = xmlInput.getBytes();
	 bout.write(buffer);
	 byte[] b = bout.toByteArray();
	 String SOAPAction =
	 "http://localhost:8080/espaciosFisicos/services/DelegadoEspaciosfisicos";
